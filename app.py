    ...
    try:
        ...
        with tab_comparativa:
            ...
            with col_linha1_dir:
                ...
                fig2.update_xaxes(showgrid=False, zeroline=False, linecolor='black', tickfont=dict(size=18))
                fig2.update_yaxes(range=[0, max_y * 1.15], showgrid=False, zeroline=False, linecolor='black', title_font=dict(size=18, color='black'), tickfont=dict(size=15.6, color='black'))
